...
class AgendamientosPage extends ConsumerStatefulWidget {
  const AgendamientosPage({super.key});

  @override
  ConsumerState<AgendamientosPage> createState() => _AgendamientosPageState();
}

class _AgendamientosPageState extends ConsumerState<AgendamientosPage> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final items = await repo.getAgendamientos(
      ...
      if (!mounted) return;
      setState(() => _error = 'No se pudieron cargar los agendamientos.');
    } finally {
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    final dataSource = AppointmentDataSource(_items);
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: TextField(
                        ...
                        decoration: const InputDecoration(
                          labelText: 'Buscar (placa, cliente)',
                    ...
                    DropdownButton<String>(
                      ...
                      items: const [
                        ...
                        DropdownMenuItem(
                            value: 'SE_PRESENTA', child: Text('Se presenta')),
                        DropdownMenuItem(
                            value: 'NO_SE_PRESENTA',
                            child: Text('No se presenta')),
                        DropdownMenuItem(
                ...
                if (_isLoading)
                  ...
                  const Center(child: Text('No se encontraron agendamientos.'))
                else
                  SingleChildScrollView(
                    ...
                    child: SizedBox(
                      ...
                      child: PaginatedDataTable(
                        header: const Text('Agendamientos'),
                        columns: _columns,
                        source: dataSource,
...
class AppointmentDataSource extends DataTableSource {
  ...
  AppointmentDataSource(this._items);
